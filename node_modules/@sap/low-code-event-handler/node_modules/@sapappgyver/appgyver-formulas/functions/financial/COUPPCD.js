const execute = require('./COUPPCD.runtime');

module.exports = {
  name: 'COUPPCD',
  category: 'Financial',
  title: 'Last coupon date before settlement date',
  description: 'Calculates the last interest payment/coupon date prior to the settlement date.',
  parameters: [{
    type: 'string',
    format: 'date-time',
    title: 'Settlement',
    description: 'The security\'s settlement date.',
  }, {
    type: 'string',
    format: 'date-time',
    title: 'Maturity',
    description: 'The security\'s maturity or end date.',
  }, {
    type: 'number',
    title: 'Frequency',
    description: 'Yearly interest/coupon payments count (1, 2, or 4).',
    enum: [1, 2, 4],
  }, {
    type: 'string',
    title: 'Basis',
