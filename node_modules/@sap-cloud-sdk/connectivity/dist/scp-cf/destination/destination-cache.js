...
function getDestinationCacheKey(token, destinationName, isolationStrategy = 'tenant-user') {
    if (isolationStrategy === 'tenant') {
        return getTenantCacheKey(destinationName, (0, jwt_1.tenantId)(getJwtForTenant(token)));
    }
    if (isolationStrategy === 'tenant-user') {
        return getTenantUserCacheKey(destinationName, (0, jwt_1.tenantId)(getJwtForTenant(token)), (0, jwt_1.userId)(getJwtForUser(token)));
    }
